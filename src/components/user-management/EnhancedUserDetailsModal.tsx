  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const updatePayload = {
        ...
        functional_email_address: formData.functional_email ? formData.functional_email_address : null,
        personal_email: formData.functional_email ? formData.functional_email_address : null,
