...
const defaultProjectData = {
  projectId: 'DP-300',
  title: 'HM Additional Compressors',
  scope: 'Hammar Mishrif Additional Compressors Project. Installation of additional compression capacity at CS3/4 to support increased gas volumes from the Hammar Mishrif field development.',
  plant: 'CS',
  station: 'CS3/4',
  hub: 'Zubair Hub',
  projectImage: 'https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=800&auto=format&fit=crop&q=60',
  teamMembers: [
    { name: 'Wolfgang Probst', role: 'Project Manager – North', isLead: true, avatarUrl: 'fbb630cc-de25-4f9e-9e8e-7c956928bb05/1767654993368.jpeg' },
  ...
  oraActivities: [
    ...
    { id: '2', name: 'SIL Assessment', dateRange: 'Dec 1 - Jan 15', progress: 100, status: 'completed' },
    { id: '3', name: 'Constructability Review', dateRange: 'Jan 5 - Feb 10', progress: 80, status: 'in_progress' },
    { id: '4', name: 'Commissioning Safety Review', dateRange: 'Feb 1 - Feb 28', progress: 45, status: 'in_progress' },
  ...
  pssrSummary: {
    ...
    completed: 0,
    inProgress: 3,
    currentPssr: 'DP-300 HM Compressors PSSR',
  },
};
