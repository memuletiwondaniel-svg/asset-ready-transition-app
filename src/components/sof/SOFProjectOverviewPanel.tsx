      ...
      <ScrollArea className="h-[calc(100vh-300px)] pr-4">
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-2">
            <Badge 
              variant="outline" 
              className="bg-blue-500/10 border-blue-500/20 text-blue-700 dark:text-blue-400 px-3 py-1.5 text-xs font-medium"
            >
            ...
            <Badge 
              variant="outline" 
              className="bg-emerald-500/10 border-emerald-500/20 text-emerald-700 dark:text-emerald-400 px-3 py-1.5 text-xs font-medium"
            >
            ...
            <Badge 
              variant="outline" 
              className="w-full justify-center bg-primary/10 border-primary/20 text-primary px-3 py-2 text-xs font-medium mt-1"
            >
