  ...
  return (
    <div className="space-y-4 p-1">
      <div className="text-center space-y-2 pb-2">
        ...
        <p className="text-sm text-muted-foreground">Review your ORA Activity Plan before creating it.</p>
      </div>

      <div className="grid grid-cols-2 gap-3">
        <Card><CardContent className="pt-4 pb-3"><p className="text-xs text-muted-foreground">Project Phase</p><p className="font-semibold mt-0.5">{phaseLabel}</p></CardContent></Card>
        <Card><CardContent className="pt-4 pb-3"><p className="text-xs text-muted-foreground">Project Type</p><p className="font-semibold mt-0.5">{typeInfo?.label}</p></CardContent></Card>
      </div>

      <div className="grid grid-cols-3 gap-3 text-center">
        <div className="p-3 rounded-lg bg-muted/30"><p className="text-2xl font-bold">{selectedActivities.length}</p><p className="text-xs text-muted-foreground">Activities</p></div>
        <div className="p-3 rounded-lg bg-muted/30"><p className="text-2xl font-bold">{withDates}</p><p className="text-xs text-muted-foreground">Scheduled</p></div>
        <div className="p-3 rounded-lg bg-muted/30"><p className="text-2xl font-bold">{withDeps}</p><p className="text-xs text-muted-foreground">With Dependencies</p></div>
      </div>
