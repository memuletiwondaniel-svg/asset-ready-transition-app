            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isSelected
                    ? 'bg-muted/60 ring-1 ring-primary/[0.32] shadow-md'
                    : 'bg-muted/20 ring-1 ring-border/30 shadow-sm hover:bg-muted/50 hover:ring-border hover:shadow-md hover:-translate-y-[1px]'
                )}
              >
