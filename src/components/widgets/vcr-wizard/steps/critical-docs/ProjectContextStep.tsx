            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isSelected
                    ? 'bg-muted/60 ring-1 ring-primary/[0.32] shadow-sm'
                    : 'bg-muted/20 ring-1 ring-border/30 hover:bg-muted/50 hover:ring-border hover:shadow-sm hover:-translate-y-[1px]'
                )}
              >
