...
export const StyledWidgetIcon: React.FC<StyledWidgetIconProps> = ({ 
  ...
  return (
    <div className="relative w-12 h-12">
      {/* Icon glow effect */}
      <div className={`absolute -inset-1 bg-gradient-to-br ${glowFrom} ${glowTo} rounded-2xl blur-lg opacity-50`}></div>
      ...
      <div className={`relative w-12 h-12 bg-gradient-to-br ${gradientFrom} ${gradientTo} rounded-xl flex items-center justify-center shadow-lg`}>
