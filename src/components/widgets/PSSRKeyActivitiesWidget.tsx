...
import { Calendar, CheckCircle2, Clock, AlertCircle, ExternalLink, Users } from 'lucide-react';
...
export const PSSRKeyActivitiesWidget: React.FC<PSSRKeyActivitiesWidgetProps> = ({
  ...
  return (
    <WidgetCard title="Key Activities">
          ...
          >
            <div className="flex items-start justify-between mb-3">
              ...
              <Button
                ...
                onClick={() => onActivityClick?.(activity.type)}
              >
