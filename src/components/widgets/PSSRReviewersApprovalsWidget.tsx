  ...
  return (
    <>
      <WidgetCard 
        ...
        className={`min-h-[600px] md:min-h-[680px] lg:min-h-[750px] ${
          widgetSize === 'compact' ? 'h-[600px] md:h-[680px] lg:h-[750px]' :
          widgetSize === 'standard' ? 'h-[750px] md:h-[820px] lg:h-[900px]' :
          'h-[950px] md:h-[1020px] lg:h-[1100px]'
        }`}
        widgetId={widgetId}
