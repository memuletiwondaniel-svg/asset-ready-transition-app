...
export const PSSRChecklistProgressWidget: React.FC<PSSRChecklistProgressWidgetProps> = ({
  ...
  return (
    <WidgetCard 
      title="Progress"
      className={`min-h-[552px] md:min-h-[623px] lg:min-h-[684px] ${
        widgetSize === 'compact' ? 'h-[552px] md:h-[623px] lg:h-[684px]' :
        widgetSize === 'standard' ? 'h-[723px] md:h-[783px] lg:h-[855px]' :
        'h-[925px] md:h-[985px] lg:h-[1055px]'
      }`}
      widgetId={widgetId}
