...
const StatusPill: React.FC<{
  ...
  <button
    onClick={onClick}
    className={`flex items-center gap-2 px-3 py-2 rounded-lg ${bgClass} hover:opacity-80 transition-all cursor-pointer group`}
  >
    <div className={`w-6 h-6 rounded-full flex items-center justify-center ${colorClass} bg-background/50`}>
