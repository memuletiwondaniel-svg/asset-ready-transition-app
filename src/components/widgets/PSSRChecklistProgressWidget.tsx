...
export const PSSRChecklistProgressWidget: React.FC<PSSRChecklistProgressWidgetProps> = ({
  ...
  return (
    <WidgetCard 
      title="Progress"
      className={`min-h-[495px] md:min-h-[560px] lg:min-h-[610px] ${
        widgetSize === 'compact' ? 'h-[495px] md:h-[560px] lg:h-[610px]' :
        widgetSize === 'standard' ? 'h-[650px] md:h-[700px] lg:h-[765px]' :
        'h-[830px] md:h-[880px] lg:h-[945px]'
      }`}
      widgetId={widgetId}
