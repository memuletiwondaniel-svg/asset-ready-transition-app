...
export const OrshSidebar: React.FC<OrshSidebarProps> = ({
  ...
  return (
    <div className={`relative border-r border-border/40 bg-card/50 backdrop-blur-xl flex flex-col transition-all duration-300 ${isSidebarCollapsed ? 'w-20' : 'w-64'}`}>
      ...
      <div className="p-4 border-t border-border/40 space-y-2">
        ...
        <Button
          ...
          className={`w-full h-9 ${isSidebarCollapsed ? 'justify-center px-0' : 'justify-start'} animate-fade-in`}
