...
import { Save, Eye, Edit2, FileText, Plus, Star, Trash2 } from 'lucide-react';
import { useCertificateTemplates } from '@/hooks/useHandoverCertificateTemplates';
import { Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DialogTrigger } from '@/components/ui/dialog';
import { Skeleton } from '@/components/ui/skeleton';

const PACCertificateEditor: React.FC = () => {
  const { data: templates, isLoading, updateTemplate, createTemplate, deleteTemplate, setDefault, isUpdating, isCreating } = useCertificateTemplates('PAC');
  ...
  const handleCreateNew = () => {
    if (newTemplateName.trim()) {
      createTemplate({
        certificate_type: 'PAC',
        name: newTemplateName,
        content: newTemplateContent || 'Enter your PAC certificate content here...',
        is_default: false,
        is_active: true,
      });
          ...
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="flex items-center gap-2">
                ...
                PAC Certificate Templates
              </CardTitle>
              <CardDescription>
                Manage and edit Provisional Acceptance Certificate templates
              </CardDescription>
            </div>
            <Dialog open={showNewDialog} onOpenChange={setShowNewDialog}>
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Create New PAC Template</DialogTitle>
                  <DialogDescription>
                    Create a new template for PAC certificates
                  </DialogDescription>
                </DialogHeader>
                <div className="space-y-4 py-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="e.g., Pipeline Handover PAC"
                    />
                  </div>
                  <div className="space-y-2">
          ...
          <CardContent>
            {isPreview ? (
              ...
              <Textarea
                ...
                placeholder="Enter PAC certificate content..."
              />
            )}
            <p className="text-xs text-muted-foreground mt-4">
              Use placeholders like [PROJECT_NAME], [FACILITY_NAME], [PAC_DATE] for dynamic content
            </p>
          </CardContent>
        </Card>
      )}
...
export default PACCertificateEditor;
