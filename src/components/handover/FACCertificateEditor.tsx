...
import { Save, Eye, Edit2, Award, Plus, Star, Trash2 } from 'lucide-react';
import { useCertificateTemplates } from '@/hooks/useHandoverCertificateTemplates';
import { Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DialogTrigger } from '@/components/ui/dialog';
import { Skeleton } from '@/components/ui/skeleton';

const FACCertificateEditor: React.FC = () => {
  const { data: templates, isLoading, updateTemplate, createTemplate, deleteTemplate, setDefault, isUpdating, isCreating } = useCertificateTemplates('FAC');
  ...
  const handleCreateNew = () => {
    if (newTemplateName.trim()) {
      createTemplate({
        certificate_type: 'FAC',
        name: newTemplateName,
        content: newTemplateContent || 'Enter your FAC certificate content here...',
        is_default: false,
        is_active: true,
      });
          ...
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="flex items-center gap-2">
                ...
                FAC Certificate Templates
              </CardTitle>
              <CardDescription>
                Manage and edit Final Acceptance Certificate templates
              </CardDescription>
            </div>
            <Dialog open={showNewDialog} onOpenChange={setShowNewDialog}>
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Create New FAC Template</DialogTitle>
                  <DialogDescription>
                    Create a new template for FAC certificates
                  </DialogDescription>
                </DialogHeader>
                <div className="space-y-4 py-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="e.g., Final Plant Handover FAC"
                    />
                  </div>
                  <div className="space-y-2">
          ...
          <CardContent>
            {isPreview ? (
              ...
              <Textarea
                ...
                placeholder="Enter FAC certificate content..."
              />
            )}
            <p className="text-xs text-muted-foreground mt-4">
              Use placeholders like [PROJECT_NAME], [FACILITY_NAME], [FAC_DATE] for dynamic content
            </p>
          </CardContent>
        </Card>
      )}
...
export default FACCertificateEditor;
