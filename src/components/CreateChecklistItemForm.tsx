        ...
        <Card className="fluent-card">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <Textarea id="description" placeholder="Enter the checklist question or requirement..." value={formData.description} onChange={e => updateFormData('description', e.target.value)} className="min-h-[12px] resize-none fluent-input" rows={2} />
