  ...
  const sections = useMemo(() => [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'selma-analytics', title: 'Selma Analytics', description: 'KPIs, learning loop, strategies', icon: Activity, gradient: 'from-cyan-500 to-blue-600', badge: 'live' as const, onClick: () => navigate('/admin/selma-analytics') },
