                      ...
                      >
                        ...
                        <div className="flex items-start gap-3 pr-6 w-full">
                          {(item as any).avatarSrc ? (
                            <div className={`w-9 h-9 aspect-square rounded-full shrink-0 group-hover:scale-110 transition-transform duration-300 bg-gradient-to-br ${item.gradient} p-[1.5px]`}>
                              <img src={(item as any).avatarSrc} alt={item.title} className="w-full h-full object-cover rounded-full aspect-square" loading="lazy" />
                            </div>
                          ) : (
