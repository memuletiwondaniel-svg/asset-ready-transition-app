...
export const NotificationCenter: React.FC = () => {
  ...
  return (
    ...
    <Popover>
      ...
      <PopoverContent 
        className="w-96 p-0 backdrop-blur-xl bg-background/98 shadow-2xl border-border/40" 
        align="end"
      >
          ...
          {loading ? (
            ...
            <div className="p-2 space-y-2">
              {notifications.map((notification, idx) => (
                <Card
                  key={notification.id}
                  className={`border-border/40 hover:border-primary/30 transition-all duration-300 cursor-pointer group animate-smooth-in ${
