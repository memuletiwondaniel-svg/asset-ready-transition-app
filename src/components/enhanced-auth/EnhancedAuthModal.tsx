                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <div className="w-5 h-5 mr-3 bg-white rounded-sm flex items-center justify-center">
                        <div className="w-3 h-3 bg-bgc rounded-sm"></div>
                      </div>
                      Continue with BGC
                    </Button>
                    ...
                    <Button
                      ...
                      disabled={loading}
                      variant="outline"
                      className="w-full h-12 text-base font-medium bg-google text-google-foreground border-border hover:bg-google/80"
                    >
