export interface CompetencyLevel {
  ...
  chartColor: string;  // HSL string for Recharts / SVG
}
...
export const competencyLevels: CompetencyLevel[] = [
  ...
  { key: 'foundational', label: 'Foundational',   min: 25, max: 49,  color: 'bg-amber-400',     dotColor: 'text-amber-400',           chartColor: 'hsl(45, 96%, 64%)' },
  { key: 'developing',   label: 'Developing',     min: 50, max: 69,  color: 'bg-amber-500',     dotColor: 'text-amber-500',           chartColor: 'hsl(38, 92%, 50%)' },
