...
const ALL_PLATFORMS: Platform[] = [
  ...
  { id: 'documentum', name: 'Documentum', description: 'Enterprise content management platform', section: 'dms', logo: documentumLogo, logoScale: 1.4, accent: '#6D28D9', badgeLabel: 'Documentum' },
