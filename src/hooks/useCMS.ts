...
export type CMSPerson = { id: string; first_name: string; last_name: string; staff_id: string; plant_id: string | null; field_id: string | null; station_id: string | null; job_title: string | null; profile_id: string | null };
