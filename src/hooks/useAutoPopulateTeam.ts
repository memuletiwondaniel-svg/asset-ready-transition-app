...
const ROLE_MATCHING_CONFIG: Record<string, { patterns: string[]; matchType: 'region' | 'hub' | 'global'; allowMultiple?: boolean; isRequired?: boolean }> = {
  ...
  // Snr. ORA Engr. - use same region matching as Construction/Commissioning Lead
  // Position format: "Snr. ORA Engr. – North" (with em-dash)
  'Snr. ORA Engr.': { patterns: ['snr. ora engr', 'snr ora engr', 'snr. ora eng', 'snr ora eng', 'senior ora'], matchType: 'region', isRequired: true },
