...
const SortableWidget: React.FC<SortableWidgetProps> = ({ id, children, onHide, className }) => {
  ...
  return (
    <div ref={setNodeRef} style={style} className={cn("group/widget relative h-full min-h-0", className)}>
      ...
      <div className="container mx-auto p-4 md:p-6 space-y-6 pb-12">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mt-4">
            <div className="min-w-0 flex items-center gap-3">
              <span
                className="shrink-0 inline-flex items-center px-2 py-0.5 rounded-md bg-muted/70 text-foreground border border-border/40 text-[12px] font-semibold tabular-nums tracking-tight leading-none"
                title="Project ID"
              >
                {getProjectId()}
              </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
            ...
            <div className="lg:row-span-3 lg:h-[calc((100vh-180px)*1.045)] lg:sticky lg:top-6">
              ...
              <div className="lg:col-span-2 lg:h-[calc((100vh-180px)*1.045)] flex flex-col">
                ...
                >
                  <SortableContext items={visibleWidgets} strategy={rectSortingStrategy}>
                    <div className="grid grid-cols-1 md:grid-cols-2 auto-rows-fr gap-6 flex-1 min-h-0 items-stretch">
