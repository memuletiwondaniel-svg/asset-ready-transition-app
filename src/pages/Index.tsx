    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* PSSR Module */}
          <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => handleModuleClick('pssr')}>
          ...
          {/* PAC Module */}
          <Card className="hover:shadow-lg transition-shadow cursor-pointer opacity-75" onClick={() => handleModuleClick('pac')}>
            <CardHeader className="text-center pb-4">
          ...
          {/* FAC Module */}
          <Card className="hover:shadow-lg transition-shadow cursor-pointer opacity-75" onClick={() => handleModuleClick('fac')}>
            <CardHeader className="text-center pb-4">
