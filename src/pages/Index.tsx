  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {!showAuth && (
        ...
        >
          {/* Feathered top hairline — fades in before PSSR, fades out after SoF/PAC.
              Contained segment under the four rail items; touches neither edge. */}
          <div
            aria-hidden
            className="pointer-events-none absolute top-0 left-0 right-0 h-px"
            style={{
              background:
                "linear-gradient(90deg, rgba(255,255,255,0) 0%, rgba(255,255,255,0) 4%, rgba(255,255,255,0.10) 12%, rgba(255,255,255,0.20) 24%, rgba(255,255,255,0.20) 36%, rgba(255,255,255,0.10) 46%, rgba(255,255,255,0) 52%)",
            }}
          />
