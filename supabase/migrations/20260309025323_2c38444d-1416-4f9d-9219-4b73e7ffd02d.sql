...
-- Fix existing P2A task titles to remove the full project name suffix
UPDATE public.user_tasks
SET title = 'Create P2A Plan'
WHERE type = 'task'
  AND metadata->>'action' = 'create_p2a_plan';

-- Update trigger to use just 'Create P2A Plan' without project name in title
