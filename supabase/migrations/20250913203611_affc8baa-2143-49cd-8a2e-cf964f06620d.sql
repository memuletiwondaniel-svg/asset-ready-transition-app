-- Drop the existing function and recreate it with the position field
...
RETURNS TABLE(
  ...
  "position" text  -- Add position field to the return type
)
LANGUAGE plpgsql
...
BEGIN
  ...
  SELECT 
    ...
    p."position"  -- Include position field in the SELECT
