-- Assign role UUIDs to 20 users with missing roles (data fix)

-- Ops Team Leads (4 users)
...
UPDATE profiles SET role = '790e1633-1364-424c-afaf-b6c993f9bdfa' WHERE full_name = 'Abbas Ali' AND role IS NULL;
UPDATE profiles SET role = '14defdba-4739-4e4e-a94e-c5c560531dc2' WHERE full_name = 'David Ireland' AND role IS NULL;
UPDATE profiles SET role = '2089e8e0-5362-4b44-b13d-ab5aacc4e899' WHERE full_name = 'Fiirat Al-Naim' AND role IS NULL;
UPDATE profiles SET role = 'ed6046ca-a68c-4840-a2ba-787f0fd6f3d5' WHERE full_name = 'Fraser  Mentiplay' AND role IS NULL;
UPDATE profiles SET role = '981e268b-470e-43ad-ab48-2d1d3eda5d30' WHERE full_name = 'Mohammed Ali Lafta' AND role IS NULL;
UPDATE profiles SET role = '2a0b011c-240d-4259-bc39-5adbb6fbebc3' WHERE full_name = 'Murtadha Emad' AND role IS NULL;