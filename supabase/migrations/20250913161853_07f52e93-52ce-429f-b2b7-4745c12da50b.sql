-- Fix the function to use final_role instead of role
...
BEGIN
  ...
  GROUP BY 
    ...
    p.avatar_url, p.final_role, p.login_attempts, p.locked_until, p.password_change_required,
