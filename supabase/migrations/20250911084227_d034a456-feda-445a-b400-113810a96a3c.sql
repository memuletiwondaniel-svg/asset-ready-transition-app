...
WITH numbered_items AS (
  ...
  WHERE is_active = true AND unique_id IS NULL
)
...
DROP TRIGGER IF EXISTS checklist_item_unique_id_trigger ON public.checklist_items;
